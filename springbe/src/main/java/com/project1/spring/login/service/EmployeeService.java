...
public class EmployeeService {
    ...
    public List<Employee> findByFirstNameOrLastNameAndAgeAndEmailId(String firstName, String lastName, long age,
            String emailId) {
        return employeeRepository.findByFirstNameOrLastNameAndAgeAndEmailId(firstName, lastName, age, emailId);
    }
}
